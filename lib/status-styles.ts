...
export const statusMap: Record<string, StatusStyle> = {
  ...
  "PRA STUNTING":  { bg: "#FFF4E5", text: "#B06000", dot: "#B06000", border: "#FEF3C7" },
  STUNTING:        { bg: "#FCE8E6", text: "#D93025", dot: "#D93025", border: "#FEE2E2" },
  "Risiko Rendah": { bg: "#E6F4EA", text: "#1E8E3E", dot: "#1E8E3E", border: "#DCFCE7" },
  "Risiko Sedang": { bg: "#FFF4E5", text: "#B06000", dot: "#B06000", border: "#FEF3C7" },
  "Risiko Tinggi": { bg: "#FCE8E6", text: "#D93025", dot: "#D93025", border: "#FEE2E2" },
