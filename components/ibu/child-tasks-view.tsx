...
export default function ChildTasksView() {
  ...
  useEffect(() => {
    setMounted(true)
    try {
      const saved = JSON.parse(localStorage.getItem('tugas_anak_state') || '{}')
      setChecked(saved)
    } catch {}
  }, [])
  ...
  function toggle(id: number) {
    setChecked(prev => {
      ...
      try { localStorage.setItem('tugas_anak_state', JSON.stringify(next)) } catch {}
      return next
    })
  }
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto no-scrollbar px-5 pt-4 pb-[108px]">
        ...
        <div className="flex gap-[11px] items-start bg-gradient-to-b from-white to-[#F1F7FE] border border-[#E4EDE7] rounded-[16px] p-[13px_14px]">
          ...
          <div>
            ...
            <div className="text-[11.5px] font-normal text-[#4C545F] leading-[1.5] mt-[3px]">
              Jangan lupa lengkapi tugas harian Aira ya, agar tumbuh kembangnya optimal!
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between mt-[22px] mb-3 px-0.5">
          <h2 className="text-[15px] font-semibold text-[#1F2937]">Status Pertumbuhan Anak</h2>
        </div>
        <div className="flex flex-col gap-[10px]">
          <div className="flex gap-[11px] items-start bg-[#F1F7FE] border border-[#C4DDF5] rounded-[14px] p-[12px_13px]">
            ...
            <div>
              ...
              <div className="text-[11.5px] font-normal text-[#4C545F] leading-[1.5] mt-[3px]">
                Pertumbuhan Aira sesuai usianya (Normal). Tumbuh kembang si kecil terpantau baik. Pertahankan pola makan bergizi dan rutin ke posyandu, ya!
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-[11px] items-start bg-[#FFF7E6] border border-[#F4E2BC] rounded-[14px] p-[12px_13px]">
            ...
            <div>
              ...
              <div className="text-[11.5px] font-normal text-[#4C545F] leading-[1.5] mt-[3px]">
                Pertumbuhan Aira masuk kategori perlu perhatian (gizi kurang / risiko stunting). Tingkatkan protein hewani dan pantau kenaikan berat tiap bulan, ya Bunda.
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-[11px] items-start bg-[#FEF1F1] border border-[#F6D2D2] rounded-[14px] p-[12px_13px]">
            ...
            <div>
              ...
              <div className="text-[11.5px] font-normal text-[#4C545F] leading-[1.5] mt-[3px]">
                Pertumbuhan Aira jauh di bawah standar usianya (stunting / gizi buruk). Jangan ditunda, segera konsultasi ke puskesmas untuk penanganan dan program makanan tambahan (PMT).
              </div>
            </div>
          </div>
        </div>
