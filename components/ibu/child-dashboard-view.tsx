    ...
    <div className="flex-1 flex flex-col overflow-y-auto no-scrollbar scroll-smooth">
      ...
      <header className="shrink-0 px-[22px] pt-[6px] pb-4 bg-gradient-to-b from-white to-[#F1F7FE] rounded-b-[24px] shadow-[0_6px_16px_-10px_rgba(17,120,212,0.4)] z-[5]">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-[17px] font-semibold text-[#1F2937] tracking-tight leading-tight">Halo, Bunda!</h1>
            <p className="text-[11.5px] font-normal text-[#697079] mt-[3px] leading-[1.4]">
              Mari pantau perkembangan <b className="text-[#1178D4] font-semibold">{childData.nama}</b>. Yuk berikan yang terbaik untuk tumbuh kembangnya.
            </p>
          </div>
          <button 
      ...
      <main className="px-5 pt-4 pb-[108px]">
          ...
          <div className="flex gap-2.5 mt-4">
            <div className="flex-1 bg-white/10 border border-white/20 rounded-[14px] p-3">
              ...
              <div className="text-[18px] font-bold mt-1 tracking-tight">
                {new Date(childData.tanggalLahir).toLocaleDateString('id-ID', { day: 'numeric', month: 'short' })}<small className="text-[11px] font-medium opacity-85 ml-1"> {new Date(childData.tanggalLahir).getFullYear()}</small>
              </div>
            </div>
            <div className="flex-1 bg-white/10 border border-white/20 rounded-[14px] p-3">
              <div className="flex items-center gap-1.5 text-[10px] font-medium opacity-85">
              ...
              <div className="text-[18px] font-bold mt-1 tracking-tight">
                14 Jun<small className="text-[11px] font-medium opacity-85 ml-1"> posyandu</small>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white border border-[#E4EDE7] rounded-[18px] p-4 shadow-[0_4px_14px_-8px_rgba(9,30,66,0.12)] flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[11px] font-medium text-[#697079]">Kepatuhan tugas anak hari ini</div>
        ...
        {/* RISK */}
        <div className="flex items-center justify-between mt-5 mb-2.5 px-0.5">
          <h2 className="text-[14px] font-semibold text-[#1F2937]">Indikator Risiko Stunting Anak</h2>
        </div>
        <section className="bg-white border border-[#E4EDE7] rounded-[18px] p-4 shadow-[0_4px_14px_-8px_rgba(9,30,66,0.12)]">
          ...
          <div className="grid grid-cols-2 gap-2 mt-4">
            <div className="bg-[#F1F7FE] border border-[#E4EDE7] rounded-[13px] p-2.5 text-center">
              ...
              <div className="text-[17px] font-bold text-[#1F2937] mt-1 tracking-tight leading-none">
                {childData.lastPengukuran?.tinggiBadan || '-'}<small className="text-[9px] font-medium text-[#697079] ml-0.5"> cm</small>
              </div>
              <span className="inline-block mt-1.5 px-2 py-0.5 rounded-full bg-[#E7F7EF] text-[#1E9E62] text-[8.5px] font-bold">Sesuai usia</span>
            </div>
            <div className="bg-[#F1F7FE] border border-[#E4EDE7] rounded-[13px] p-2.5 text-center">
              <div className="text-[10px] font-medium text-[#697079]">Berat Badan</div>
              <div className="text-[17px] font-bold text-[#1F2937] mt-1 tracking-tight leading-none">
                {childData.lastPengukuran?.beratBadan || '-'}<small className="text-[9px] font-medium text-[#697079] ml-0.5"> kg</small>
              </div>
              <span className="inline-block mt-1.5 px-2 py-0.5 rounded-full bg-[#E7F7EF] text-[#1E9E62] text-[8.5px] font-bold">Normal</span>
            </div>
            <div className="bg-[#E4F3FD] border border-[#BFE3FA] rounded-[13px] p-2.5 text-center">
              <div className="text-[10px] font-medium text-[#697079]">Z-score HAZ</div>
              <div className="text-[17px] font-bold text-[#1F2937] mt-1 tracking-tight leading-none">
                {childData.lastPengukuran?.zScoreTBU || '-'}<small className="text-[9px] font-medium text-[#697079] ml-0.5"> SD</small>
              </div>
              <span className="inline-block mt-1.5 px-2 py-0.5 rounded-full bg-[#E7F7EF] text-[#1E9E62] text-[8.5px] font-bold">Normal</span>
            </div>
            <div className="bg-[#F1F7FE] border border-[#E4EDE7] rounded-[13px] p-2.5 text-center">
              <div className="text-[10px] font-medium text-[#697079]">Kunjungan Terakhir</div>
              <div className="text-[17px] font-bold text-[#1F2937] mt-1 tracking-tight leading-none">
                {childData.lastPengukuran ? new Date(childData.lastPengukuran.tanggal).toLocaleDateString('id-ID', { day: 'numeric', month: 'short' }) : '-'}<small className="text-[9px] font-medium text-[#697079] ml-0.5"></small>
              </div>
              <span className="inline-block mt-1.5 px-2 py-0.5 rounded-full bg-[#EAEFF4] text-[#697079] text-[8.5px] font-bold">Posyandu</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between gap-2.5 mt-4">
            <span className="flex items-center gap-1.5 text-[9.5px] text-[#989DA3] font-normal leading-tight max-w-[135px]">
              ...
              Z-score HAZ diukur di posyandu. Data diperbarui tiap kunjungan.
            </span>
            <Link href="/ibu/anak" className="shrink-0 inline-flex items-center gap-1.5 px-4 py-2.5 rounded-[13px] bg-gradient-to-br from-[#2B93E6] to-[#1178D4] text-white text-[13px] font-semibold shadow-[0_10px_20px_-8px_rgba(17,120,212,0.7)] active:scale-95 transition-all">
        ...
        <div className="flex gap-3">
          <Link href="/ibu/edukasi" className="flex-1 bg-white border border-[#E4EDE7] rounded-[16px] p-3.5 shadow-[0_4px_12px_-8px_rgba(9,30,66,0.14)] active:translate-y-0.5 transition-all">
            ...
            <div className="text-[10.5px] font-normal text-[#697079] mt-1 leading-snug">Tumbuh kembang usia 1–2 tahun</div>
