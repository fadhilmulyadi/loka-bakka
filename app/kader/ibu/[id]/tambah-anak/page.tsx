...
const requiredFields = ["nama", "sex", "birth"] as const
...
export default function TambahAnakIbuPage() {
  ...
  useEffect(() => {
    getIbuById(id).then(setIbu).catch(() => router.push("/kader/rekap"))
  }, [id, router])
  ...
  if (!ibu) return <div className="flex-1 flex items-center justify-center bg-[#EBF2F8]">Loading...</div>
    ...
    <div className="flex-1 bg-[#EBF2F8] flex flex-col">
      ...
      <div className="flex items-center gap-3 px-4 pt-4 pb-2 z-10">
        ...
        <div className="flex-1 flex items-center gap-2 px-4 h-8 bg-white rounded-[50px] shadow-[2px_2px_8px_rgba(0,0,0,0.08)]">
          ...
          <span className="text-xs text-[#173753] truncate font-medium">Tambah anak untuk {ibu.nama}</span>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            <nav className="flex items-center gap-1 mb-1.5" aria-label="Breadcrumb">
              ...
              <ChevronRight className="w-3 h-3 text-[#173753]/30 flex-none" />
              <Link href={`/kader/ibu/${id}`} className="text-xs text-[#173753]/50 hover:text-[#173753] transition-colors">{ibu.nama}</Link>
              <ChevronRight className="w-3 h-3 text-[#173753]/30 flex-none" />
          ...
          <div className="flex flex-col gap-4 sticky top-6">
            ...
            <Card className="ring-0 shadow-[2px_2px_8px_rgba(0,0,0,0.08)] bg-white rounded-xl">
              ...
              <CardContent className="pt-2 px-4">
                ...
                >
                  {[
                    { label: "Posyandu", value: "Posyandu Melati" },
                    {
                      label: "Tgl lahir",
                      value: f.birth
            ...
            <Button
              ...
              onClick={() => router.push(`/kader/ibu/${id}`)}
            >
              Batal
            </Button>
          </div>
