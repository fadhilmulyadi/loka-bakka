...
export default function IbuDashboardPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (st) {
        ...
        // Use functional updates or move out of effect if it's derived
        setScore(newScore)
  ...
  if (loading) return <div className="flex-1 flex items-center justify-center bg-white">Loading...</div>
      ...
      <header className="shrink-0 px-[22px] pt-[6px] pb-4 bg-gradient-to-b from-white to-[#F1F7FE] rounded-b-[24px] shadow-[0_6px_16px_-10px_rgba(17,120,212,0.4)] z-[5]">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-[17px] font-semibold text-[#1F2937] tracking-tight leading-tight">Halo, Bunda {ibuData?.nama || '...'}!</h1>
            <p className="text-[11.5px] font-normal text-[#697079] mt-[3px] leading-[1.4]">
              Hari ini usia kandunganmu <b className="text-[#1178D4] font-semibold">{ibuData?.weeksPregnant || 24} minggu</b>. Yuk, berikan si kecil yang terbaik hari ini.
            </p>
          </div>
          <button 
      ...
      <main className="px-5 pt-4 pb-[108px]">
        ...
        <section className="relative rounded-[22px] p-5 overflow-hidden text-white bg-gradient-to-br from-[#2B93E6] via-[#1178D4] to-[#0A487F] shadow-[0_16px_34px_-16px_rgba(17,120,212,0.6)] isolate">
          ...
          <div className="flex items-end gap-2 mt-3">
            <span className="text-[52px] font-bold leading-[0.9] tracking-tighter">24</span>
          ...
          <div className="flex gap-2.5 mt-4">
            <div className="flex-1 bg-white/10 border border-white/20 rounded-[14px] p-3">
              ...
              <div className="text-[18px] font-bold mt-1 tracking-tight">
                12 Sep<small className="text-[11px] font-medium opacity-85 ml-1"> 2026</small>
              </div>
            </div>
            <div className="flex-1 bg-white/10 border border-white/20 rounded-[14px] p-3">
              <div className="flex items-center gap-1.5 text-[10px] font-medium opacity-85">
        ...
        <section className="bg-white border border-[#E4EDE7] rounded-[18px] p-4 shadow-[0_4px_14px_-8px_rgba(9,30,66,0.12)]">
          ...
          <div className="flex gap-2 mt-4">
            <div className="flex-1 bg-[#F1F7FE] border border-[#E4EDE7] rounded-[13px] p-2.5 text-center">
              ...
              <div className="text-[17px] font-bold text-[#1F2937] mt-1 tracking-tight leading-none">25,1<small className="text-[9px] font-medium text-[#697079] ml-0.5"> cm</small></div>
            ...
            <div className="flex-1 bg-[#F1F7FE] border border-[#E4EDE7] rounded-[13px] p-2.5 text-center">
              ...
              <div className="text-[17px] font-bold text-[#1F2937] mt-1 tracking-tight leading-none">11,8<small className="text-[9px] font-medium text-[#697079] ml-0.5"> g/dL</small></div>
              <span className="inline-block mt-1.5 px-2 py-0.5 rounded-full bg-[#E7F7EF] text-[#1E9E62] text-[8.5px] font-bold">Normal</span>
            </div>
            <div className="flex-1 bg-[#F1F7FE] border border-[#E4EDE7] rounded-[13px] p-2.5 text-center">
